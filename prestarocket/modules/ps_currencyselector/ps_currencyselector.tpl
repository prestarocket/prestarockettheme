...
<div id="_desktop_currency_selector">
    <div class="currency-selector dropdown js-dropdown">
        ...
        <button data-target="#" data-toggle="dropdown" class="d-none d-md-inline-block btn-unstyle" aria-haspopup="true" aria-expanded="false" aria-label="{l s='Currency dropdown' d='Shop.Theme.Global'}">
